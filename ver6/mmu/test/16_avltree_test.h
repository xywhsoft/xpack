...
void test_avltree()
{
	...
	for ( int i = 0; i < 10; i++ ) {
		AVLT_Test_Object objNode = AVLTree_Insert(objTree, (void*)(intptr_t)iValArr1[i], NULL);
		if ( objNode ) {
	...
	for ( int i = 0; i < 10; i++ ) {
		...
		if ( objNode ) {
			printf("AVLTree search node , k&v = %d & %d (%d)\t\t\t\tpass! √\n", iValArr1[i], objNode->Val, AVLTree_GetNodeBase(objNode)->height);
		} else {
	...
	for ( int i = 0; i < 10; i++ ) {
		AVLT_Test_Object objNode = AVLTree_Insert(objTree, (void*)(intptr_t)iValArr2[i], NULL);
		if ( objNode ) {
	...
	for ( int i = 0; i < 10; i++ ) {
		AVLT_Test_Object objNode = AVLTree_Insert(objTree, (void*)(intptr_t)iValArr3[i], NULL);
		if ( objNode ) {
	...
	for ( int i = 0; i < 10; i++ ) {
		int bNew;
		AVLT_Test_Object objNode = AVLTree_Insert(objTree, (void*)(intptr_t)iValArr4[i], &bNew);
		if ( objNode ) {
	...
	for ( int i = 0; i < 30; i++ ) {
		int bNew;
		AVLT_Test_Object objNode = AVLTree_Insert(objTree, (void*)(intptr_t)iValArr5[i], &bNew);
		if ( objNode ) {
