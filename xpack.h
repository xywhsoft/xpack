...
/* xPack requires xrt and keeps xrt as an external dependency. */
...
#		include "lib/xrt.h"
#	else
#		error "xpack requires xrt.h to be available in the include path"
#	endif
#else
#	include "lib/xrt.h"
#endif
...
/* Third-party compression libraries stay external dependencies. */
#if defined(__has_include)
...
#ifndef XPK_BASE_TYPES_H
#define XPK_BASE_TYPES_H
...
#ifndef XPK_BASE_TIME_H
#define XPK_BASE_TIME_H
