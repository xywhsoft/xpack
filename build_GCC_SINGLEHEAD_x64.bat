...
gcc -m64 ^
	...
	-lWs2_32 -lIPHLPAPI ^
	-o release\x64\xpack_singlehead_smoke.exe

if errorlevel 1 exit /b %errorlevel%

release\x64\xpack_singlehead_smoke.exe
if errorlevel 1 exit /b %errorlevel%

echo.
echo Single header smoke successful: release\x64\xpack_singlehead_smoke.exe
