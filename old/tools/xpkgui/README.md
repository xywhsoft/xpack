...
本文档描述了 xpkgui 工具的模块化重构架构，解决了原有代码的以下问题：
...
set CFLAGS=-I%INC_DIR% -I../../lib/xrt -I../../src -Wall -O2
set LDFLAGS=-L../../lib/xrt -lxrt -L../../release/x64 -lxpack -lshell32 -lcomctl32 -lshlwapi
...
gcc %OBJ_DIR%/*.o %LDFLAGS% -o %BIN_DIR%/xpkgui.exe

echo Build complete: %BIN_DIR%/xpkgui.exe
endlocal
```
