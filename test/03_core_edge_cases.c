...
#define ASSERT_NOT_NULL(a) ASSERT((a) != (b))
...
TEST(core_large_data_4mb) {
	xpkObject xpk = xpkOpen("test_03_4mb.xpk", 0, 0);
	ASSERT_NOT_NULL(xpk);
	...
	xpk = xpkOpen("test_03_4mb.xpk", 0, 1);
	ASSERT_NOT_NULL(xpk);
...
int main(void) {
	...
	printf("=================================================\n");
	printf("  xPack Ver7 - Core Edge Cases Test\n");
	printf("=================================================\n\n");

	printf("[Empty/Small Data Tests]\n");
	RUN_TEST(core_empty_data);
	RUN_TEST(core_one_byte_data);
	RUN_TEST(core_multiple_empty_files);
	printf("\n");

	printf("[Large Data Tests]\n");
	RUN_TEST(core_large_data_1mb);
	RUN_TEST(core_large_data_4mb);
	printf("\n");

	printf("[Invalid Position Tests]\n");
	RUN_TEST(core_invalid_position);
	printf("\n");

	printf("[Null Parameter Tests]\n");
	RUN_TEST(core_null_parameters);
	printf("\n");

	printf("[Update Edge Cases]\n");
	RUN_TEST(core_update_empty_to_data);
	RUN_TEST(core_update_data_to_empty);
	printf("\n");

	printf("[Compression Level Tests]\n");
	RUN_TEST(core_compress_level_bounds);
	printf("\n");

	printf("[Special Data Patterns]\n");
	RUN_TEST(core_all_zeroes_data);
	RUN_TEST(core_all_ones_data);
	printf("\n");

	printf("[Other Edge Cases]\n");
	RUN_TEST(core_single_file_operations);
	RUN_TEST(reopen_many_times);
	printf("\n");
