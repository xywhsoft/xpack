...
REM 编译测试运行器（统一运行所有测试）
echo [1/2] Compiling test runner...
gcc %CFLAGS% %OPTFLAGS% test_framework.c test_runner.c %XPACK_SRC% %XRT_SRC% %LZ4_SRC% %ZSTD_SRC% %LZMA_SRC% %LDFLAGS% -o %OUTPUT_DIR%\test_runner.exe
if %ERRORLEVEL% neq 0 (
