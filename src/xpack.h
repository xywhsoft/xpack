...
// 版本标识
// ============================================================================
#define XPK_SIGNATURE       0x006B7078      // "xpk\0" 文件签名
#define XPK_VERSION         7               // 版本号
...
typedef struct {
    // 基础标识 (8 bytes)
    uint32_t        signature;          // [0-3]   文件签名 "xpk\0"
    uint8_t         version;            // [4]     版本号
    uint8_t         reserved0;          // [5]     保留
    uint16_t        infoExtSize;        // [6-7]   文件信息扩展大小
